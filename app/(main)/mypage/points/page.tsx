    ...
    <div className="space-y-4">
      ...
      <section>
        {pointTransactions.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-slate-200 bg-white p-6 text-center text-sm text-slate-400 shadow-[0_8px_20px_rgba(15,23,42,0.04)]">포인트 적립 내역이 없습니다.</div>
        ) : (
              ...
              <div key={transaction.id} className="p-4">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-slate-500">적립일 · {formatDate(transaction.created_at)}</p>
