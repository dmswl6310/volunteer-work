...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-slate-50/95 px-4 py-3 pb-safe backdrop-blur">
      <div className="mx-auto flex max-w-md items-center justify-between rounded-3xl border border-slate-200/80 bg-white px-6 py-3 shadow-[0_8px_24px_rgba(15,23,42,0.08)]">
        {tabs.map((tab) => {
          const Icon = tab.icon;
